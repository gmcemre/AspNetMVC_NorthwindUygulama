...
namespace AspNetMVC_NorthwindUygulama.Models
{
    using System;
    ...
    public partial class NorthwindContext : DbContext
    {
        ...
        [DbFunction("NorthwindContext", "KategoriyeGöreUrunler")]
        public virtual IQueryable<KategoriyeGöreUrunler_Result> KategoriyeGöreUrunler(Nullable<int> kId)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<KategoriyeGöreUrunler_Result>("[NorthwindContext].[KategoriyeGöreUrunler](@kId)", kIdParameter);
        }
